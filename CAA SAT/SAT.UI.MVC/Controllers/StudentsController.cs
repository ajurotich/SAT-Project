...
namespace SAT.UI.MVC.Controllers {
	public class StudentsController : Controller {
		...
		public async Task<IActionResult> Create([Bind("StudentId,FirstName,LastName,FullName,Major,Address,City,State,ZipCode,Phone,Email,PhotoUrl,Ssid")] Student student) {
